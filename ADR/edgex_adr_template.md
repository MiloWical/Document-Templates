...
_Note: This is a duplicate of the [Architecture Decision Record (ADR) template for EdgeX Foundry](https://github.com/joelparkerhenderson/architecture-decision-record/tree/main/locales/en/templates/decision-record-template-by-edgex) template._